...
function toSafePropName(name: string): string {
...
function generateType(node: ASTNode, name: string, depth: number): string {
...
export const TypeScriptGenerator: FormatGenerator = {
  name: "typescript",
